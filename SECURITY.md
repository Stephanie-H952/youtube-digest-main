...
- requests to network origins outside the documented YouTube, Supadata, and Anthropic hosts;
...
- bypasses of local data deletion or Anthropic configuration controls.
